...
Replace `data-sveltekit-...="off"` with `data-sveltekit-...="false"`.

#### References

- [Migrating to SvelteKit v3](https://next.svelte.dev/docs/kit/migrating-to-sveltekit-3#Miscellaneous-data-sveltekit-uses-false-instead-of-'off')

#### Files to review

- [ ] `src/lib/components/game-list/game-card.svelte`
